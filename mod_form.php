...
class mod_skillsaudit_mod_form extends moodleform_mod {
    ...
    public function definition() {
		...
		foreach($skills as $skill) {
			$html .= '<tr class="skill_row" id="skill_row_' . $skill->id . '"><td class="skill_number"><a class="skill_help_link" href="'  . $skill->link . '" target="_blank">';
			if(strlen($skill->link) > 0) {
				$html .= '<span class="info_icon"></span>';				
			}

			$html .= $skill->number . '</a></td><td class="skill_description">' . $skill->description . '</td><td>';

...
$string['areatofocuson'] = 'Area to focus on';
$string['strongestarea'] = 'Your strongest area';
$string['date'] = 'Date';
$string['wholecourse'] = 'Whole course';
$string['thistopic'] = 'This topic';
$string['individualskills'] = 'Individual skills';
$string['noratingstarget'] = 'Rate your confidence for each learning objective';
$string['targetlinktooltip'] = 'Click here for more info';
$string['suggestedtarget'] = 'Suggested target';
$string['total'] = 'Total';
$string['aboutconfidence'] = '<strong>Confidence</strong> means how much you said you understood each learning objective.';
$string['aboutcoverage'] = '<strong>Coverage</strong> means how many learning objectives you have rated so far.';
$string['aboutcompetence'] = '<strong>Competence</strong> means your average test score or grade from these activities';

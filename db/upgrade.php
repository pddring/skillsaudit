...
function xmldb_skillsaudit_upgrade($oldversion) {
     ...
     * for demonstrative purposes and to show how the skillsaudit
     * iself has been upgraded.
     *
     * For each upgrade block, the file skillsaudit/version.php
    ...
    if ($oldversion < 2007040100) {
        ...
        // Define field course to be added to skillsaudit.
        ...
        // Define field intro to be added to skillsaudit.
        $table = new xmldb_table('skillsaudit');
        ...
        // Define field introformat to be added to skillsaudit.
        $table = new xmldb_table('skillsaudit');
        ...
        upgrade_mod_savepoint(true, 2007040100, 'skillsaudit');
    }
    ...
    if ($oldversion < 2007040101) {
        ...
        // Define field timecreated to be added to skillsaudit.
        $table = new xmldb_table('skillsaudit');
        ...
        // Define field timemodified to be added to skillsaudit.
        $table = new xmldb_table('skillsaudit');
        ...
        // Define index course (not unique) to be added to skillsaudit.
        $table = new xmldb_table('skillsaudit');
        ...
        upgrade_mod_savepoint(true, 2007040101, 'skillsaudit');
    }
    ...
    if ($oldversion < 2007040200) {
        ...
        upgrade_mod_savepoint(true, 2007040200, 'skillsaudit');
    }
